...
(() => {
  ...
  // DEMO TEXT TEMPORARILY HIDDEN — restore the commented line below to re-enable:
  ...
  function holdingSheet(sym) {
    ...
    openSheet(h.name, `
      ...
      ${'' /* DEMO-NOTE (hidden): Demo position · not investment advice. */}`);
  }
  function subSheet(id) {
    ...
    openSheet(s.name, `
      ...
      ${'' /* DEMO-NOTE (hidden): No real charge occurs. Demo only. */}`);
  }
  function txnSheet(id) {
    ...
    openSheet(t.title, `
      ...
      ${'' /* DEMO-NOTE (hidden): Demo transaction. */}`);
  }
  function cardSheet(id) {
    ...
    openSheet(c.type, `
      ...
      ${'' /* DEMO-NOTE (hidden): Full numbers are never shown. No real card. */}`);
  }
  ...
  function transferSheet() {
    ...
    openSheet('Transfer money', `
      ...
      ${'' /* DEMO-NOTE (hidden): No money actually moves. Demo only. */}`, () => {
      $('#trGo').onclick = async () => {
  ...
  function depositSheet() {
    openSheet('Mobile deposit', `
      ...
      ${'' /* DEMO-NOTE (hidden): No image is uploaded or stored. Demo only. */}`, () => {
      $('#dpGo').onclick = async () => {
  ...
  function payBillSheet(subId) {
    ...
    openSheet('Pay a bill', `
      ...
      ${'' /* DEMO-NOTE (hidden): No real payment is sent. Demo only. */}`, () => {
  ...
  function tradeSheet(presym, side) {
    ...
    openSheet('Trade', `
      ...
      ${'' /* DEMO-NOTE (hidden): No order is sent. Demo only. */}`, () => {
      ...
      $('#tkPreview').onclick = () => {
        ...
        openSheet('Confirm order', `
          ...
          ${'' /* DEMO-NOTE (hidden): Orders are simulated — nothing is executed. */}`, () => {
